$(document).ready(function(){
    ...
    if(isMobile.any()) {
       ...
       $( ".nav_search #custom-search-input" ).css( "margin-left", "300px" );
       $( ".md_aud_wrap .ui360 .sm2-360btn" ).css( 'width' : '270px' , 'height' : '243px' );
       $( ".md_aud_wrap .ui360-vis" ).css( 'width' : '305px' , 'height' : '317px' );
       $( ".md_aud_wrap .ui360-vis .sm2-360ui.sm2_playing .sm2-360btn" ).css( 'margin-left' : '45px' , 'margin-top' : '38px' );
       $( ".md_aud_wrap .ui360-vis .sm2-360ui.sm2_paused .sm2-360btn" ).css( 'margin-left' : '45px' , 'margin-top' : '38px' );
       $( ".md_aud_wrap .ui360 .sm2-timing" ).css( 'left' : '70px' , 'top' : '75%' );
       $( ".md_aud_wrap .ui360 .sm2-canvas" ).css( 'left' : '70px' , 'top' : '55px' );
    }
